...
<body>
	...
	%>
	<ul>
		<li>저자: ${book2.author}</li>	<%-- 자동으로 ${book2.getAuthor()} 호출되어 실해된다. --%>
		<li>제목: ${book2.title}</li>		<%-- 자동으로 ${book2.getTitle()} 호출되어 실해된다. --%>
		<li>가격: ${book2.price}</li>		<%-- 자동으로 ${book2.getPrice()} 호출되어 실해된다. --%>
	</ul>
